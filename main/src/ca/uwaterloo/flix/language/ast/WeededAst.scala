...
object WeededAst {
  ...
  object Declaration {
    ...
    case class Instance(doc: Ast.Doc, mod: Ast.Modifiers, ident: Name.Ident, tpe: WeededAst.Type, defs: List[WeededAst.Declaration.Def], loc: SourceLocation) extends WeededAst.Declaration
  ...
  object Expression {
    ...
    case class VarDefSig(name: Name.QName, loc: SourceLocation) extends WeededAst.Expression
