...
object NamedAst {
  ...
  object Expression {
    ...
    case class Apply(exp: NamedAst.Expression, exps: List[NamedAst.Expression], tvar: ast.Type.Var, evar: ast.Type.Var, loc: SourceLocation) extends NamedAst.Expression
