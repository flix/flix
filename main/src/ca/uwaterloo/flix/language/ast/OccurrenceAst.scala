...
object OccurrenceAst {
  ...
  object Expression {
    ...
    case class OnExit(exp1: OccurrenceAst.Expression, exp2: OccurrenceAst.Expression, tpe: Type, purity: Purity, loc: SourceLocation) extends OccurrenceAst.Expression
