...
object ParsedAst {
  ...
  object Expression {
    ...
    /**
      ...
      */
    case class FixpointFold(sp1: SourcePosition, constraints: ParsedAst.Expression, init: ParsedAst.Expression, f: ParsedAst.Expression, sp2: SourcePosition) extends ParsedAst.Expression
  }
