...
object NamedAst {
  ...
  object Expression {
    ...
    case class InvokeMethod(className: String, methodName: String, targs: List[NamedAst.Type], args: List[NamedAst.Expression], tpe: ast.Type.Var, evar: ast.Eff.Var, loc: SourceLocation) extends NamedAst.Expression

    case class InvokeStaticMethod(className: String, methodName: String, args: List[NamedAst.Expression], sig: List[NamedAst.Type], tpe: ast.Type.Var, evar: ast.Eff.Var, loc: SourceLocation) extends NamedAst.Expression
