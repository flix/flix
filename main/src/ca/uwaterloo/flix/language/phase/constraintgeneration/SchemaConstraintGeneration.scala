...
object SchemaConstraintGeneration {
  ...
  def visitFixpointConstraintSet(e: KindedAst.Expr.FixpointConstraintSet)(implicit c: TypingContext, root: KindedAst.Root, flix: Flix): (Type, Type) = {
  ...
  def visitFixpointLambda(e: KindedAst.Expr.FixpointLambda)(implicit c: TypingContext, root: KindedAst.Root, flix: Flix): (Type, Type) = {
  ...
  def visitFixpointMerge(e: KindedAst.Expr.FixpointMerge)(implicit c: TypingContext, root: KindedAst.Root, flix: Flix): (Type, Type) = {
  ...
  def visitFixpointSolve(e: KindedAst.Expr.FixpointSolve)(implicit c: TypingContext, root: KindedAst.Root, flix: Flix): (Type, Type) = {
  ...
  def visitFixpointFilter(e: KindedAst.Expr.FixpointFilter)(implicit c: TypingContext, root: KindedAst.Root, flix: Flix): (Type, Type) = {
  ...
  def visitFixpointInject(e: KindedAst.Expr.FixpointInject)(implicit c: TypingContext, root: KindedAst.Root, flix: Flix): (Type, Type) = {
  ...
  def visitFixpointProject(e: KindedAst.Expr.FixpointProject)(implicit c: TypingContext, root: KindedAst.Root, flix: Flix): (Type, Type) = {
  ...
  /**
    ...
    */
  private def visitHeadPredicate(head: KindedAst.Predicate.Head)(implicit c: TypingContext, root: KindedAst.Root, flix: Flix): Type = {
