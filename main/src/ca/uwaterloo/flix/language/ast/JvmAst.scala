...
object JvmAst {
  ...
  object Expr {
    ...
    case class Var(offset: Int, sym: Symbol.VarSym, tpe: SimpleType, loc: SourceLocation) extends Expr {
      def purity: Purity = Pure
    }
    ...
    case class Let(offset: Int, sym: Symbol.VarSym, exp1: Expr, exp2: Expr, loc: SourceLocation) extends Expr {
    ...
    case class Region(offset: Int, sym: Symbol.VarSym, exp: Expr, tpe: SimpleType, purity: Purity, loc: SourceLocation) extends Expr
  ...
  case class CatchRule(offset: Int, sym: Symbol.VarSym, clazz: java.lang.Class[?], exp: Expr)
  ...
  case class OffsetFormalParam(offset: Int, sym: Symbol.VarSym, tpe: SimpleType)

  case class LocalParam(offset: Int, sym: Symbol.VarSym, tpe: SimpleType)
