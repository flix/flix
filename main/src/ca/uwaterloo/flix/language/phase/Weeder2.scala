...
object Weeder2 {
  ...
  private object Exprs {
    ...
    private def visitIntrinsic(tree: Tree, args: List[Expr])(implicit sctx: SharedContext): Validation[Expr, CompilationMessage] = {
      ...
      val types0 = traverse(pickAll(TreeKind.Type.Type, tree))(Types.visitType)
      val loc = tree.loc
      Validation.flatMapN(types0)( types => (intrinsic, args, types) match {
        case ("BOOL_NOT", e1 :: Nil, Nil) => Validation.Success(Expr.Unary(SemanticOp.BoolOp.Not, e1, loc))
        case ("BOOL_AND", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.BoolOp.And, e1, e2, loc))
        case ("BOOL_OR", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.BoolOp.Or, e1, e2, loc))
        case ("BOOL_EQ", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.BoolOp.Eq, e1, e2, loc))
        case ("BOOL_NEQ", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.BoolOp.Neq, e1, e2, loc))
        case ("CHAR_EQ", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.CharOp.Eq, e1, e2, loc))
        case ("CHAR_NEQ", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.CharOp.Neq, e1, e2, loc))
        case ("CHAR_LT", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.CharOp.Lt, e1, e2, loc))
        case ("CHAR_LE", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.CharOp.Le, e1, e2, loc))
        case ("CHAR_GT", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.CharOp.Gt, e1, e2, loc))
        case ("CHAR_GE", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.CharOp.Ge, e1, e2, loc))
        case ("FLOAT32_NEG", e1 :: Nil, Nil) => Validation.Success(Expr.Unary(SemanticOp.Float32Op.Neg, e1, loc))
        case ("FLOAT32_ADD", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Float32Op.Add, e1, e2, loc))
        case ("FLOAT32_SUB", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Float32Op.Sub, e1, e2, loc))
        case ("FLOAT32_MUL", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Float32Op.Mul, e1, e2, loc))
        case ("FLOAT32_DIV", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Float32Op.Div, e1, e2, loc))
        case ("FLOAT32_EXP", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Float32Op.Exp, e1, e2, loc))
        case ("FLOAT32_EQ", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Float32Op.Eq, e1, e2, loc))
        case ("FLOAT32_NEQ", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Float32Op.Neq, e1, e2, loc))
        case ("FLOAT32_LT", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Float32Op.Lt, e1, e2, loc))
        case ("FLOAT32_LE", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Float32Op.Le, e1, e2, loc))
        case ("FLOAT32_GT", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Float32Op.Gt, e1, e2, loc))
        case ("FLOAT32_GE", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Float32Op.Ge, e1, e2, loc))
        case ("FLOAT64_NEG", e1 :: Nil, Nil) => Validation.Success(Expr.Unary(SemanticOp.Float64Op.Neg, e1, loc))
        case ("FLOAT64_ADD", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Float64Op.Add, e1, e2, loc))
        case ("FLOAT64_SUB", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Float64Op.Sub, e1, e2, loc))
        case ("FLOAT64_MUL", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Float64Op.Mul, e1, e2, loc))
        case ("FLOAT64_DIV", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Float64Op.Div, e1, e2, loc))
        case ("FLOAT64_EXP", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Float64Op.Exp, e1, e2, loc))
        case ("FLOAT64_EQ", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Float64Op.Eq, e1, e2, loc))
        case ("FLOAT64_NEQ", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Float64Op.Neq, e1, e2, loc))
        case ("FLOAT64_LT", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Float64Op.Lt, e1, e2, loc))
        case ("FLOAT64_LE", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Float64Op.Le, e1, e2, loc))
        case ("FLOAT64_GT", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Float64Op.Gt, e1, e2, loc))
        case ("FLOAT64_GE", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Float64Op.Ge, e1, e2, loc))
        case ("INT8_NEG", e1 :: Nil, Nil) => Validation.Success(Expr.Unary(SemanticOp.Int8Op.Neg, e1, loc))
        case ("INT8_NOT", e1 :: Nil, Nil) => Validation.Success(Expr.Unary(SemanticOp.Int8Op.Not, e1, loc))
        case ("INT8_ADD", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int8Op.Add, e1, e2, loc))
        case ("INT8_SUB", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int8Op.Sub, e1, e2, loc))
        case ("INT8_MUL", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int8Op.Mul, e1, e2, loc))
        case ("INT8_DIV", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int8Op.Div, e1, e2, loc))
        case ("INT8_REM", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int8Op.Rem, e1, e2, loc))
        case ("INT8_EXP", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int8Op.Exp, e1, e2, loc))
        case ("INT8_AND", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int8Op.And, e1, e2, loc))
        case ("INT8_OR", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int8Op.Or, e1, e2, loc))
        case ("INT8_XOR", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int8Op.Xor, e1, e2, loc))
        case ("INT8_SHL", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int8Op.Shl, e1, e2, loc))
        case ("INT8_SHR", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int8Op.Shr, e1, e2, loc))
        case ("INT8_EQ", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int8Op.Eq, e1, e2, loc))
        case ("INT8_NEQ", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int8Op.Neq, e1, e2, loc))
        case ("INT8_LT", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int8Op.Lt, e1, e2, loc))
        case ("INT8_LE", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int8Op.Le, e1, e2, loc))
        case ("INT8_GT", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int8Op.Gt, e1, e2, loc))
        case ("INT8_GE", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int8Op.Ge, e1, e2, loc))
        case ("INT16_NEG", e1 :: Nil, Nil) => Validation.Success(Expr.Unary(SemanticOp.Int16Op.Neg, e1, loc))
        case ("INT16_NOT", e1 :: Nil, Nil) => Validation.Success(Expr.Unary(SemanticOp.Int16Op.Not, e1, loc))
        case ("INT16_ADD", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int16Op.Add, e1, e2, loc))
        case ("INT16_SUB", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int16Op.Sub, e1, e2, loc))
        case ("INT16_MUL", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int16Op.Mul, e1, e2, loc))
        case ("INT16_DIV", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int16Op.Div, e1, e2, loc))
        case ("INT16_REM", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int16Op.Rem, e1, e2, loc))
        case ("INT16_EXP", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int16Op.Exp, e1, e2, loc))
        case ("INT16_AND", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int16Op.And, e1, e2, loc))
        case ("INT16_OR", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int16Op.Or, e1, e2, loc))
        case ("INT16_XOR", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int16Op.Xor, e1, e2, loc))
        case ("INT16_SHL", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int16Op.Shl, e1, e2, loc))
        case ("INT16_SHR", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int16Op.Shr, e1, e2, loc))
        case ("INT16_EQ", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int16Op.Eq, e1, e2, loc))
        case ("INT16_NEQ", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int16Op.Neq, e1, e2, loc))
        case ("INT16_LT", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int16Op.Lt, e1, e2, loc))
        case ("INT16_LE", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int16Op.Le, e1, e2, loc))
        case ("INT16_GT", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int16Op.Gt, e1, e2, loc))
        case ("INT16_GE", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int16Op.Ge, e1, e2, loc))
        case ("INT32_NEG", e1 :: Nil, Nil) => Validation.Success(Expr.Unary(SemanticOp.Int32Op.Neg, e1, loc))
        case ("INT32_NOT", e1 :: Nil, Nil) => Validation.Success(Expr.Unary(SemanticOp.Int32Op.Not, e1, loc))
        case ("INT32_ADD", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int32Op.Add, e1, e2, loc))
        case ("INT32_SUB", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int32Op.Sub, e1, e2, loc))
        case ("INT32_MUL", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int32Op.Mul, e1, e2, loc))
        case ("INT32_DIV", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int32Op.Div, e1, e2, loc))
        case ("INT32_REM", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int32Op.Rem, e1, e2, loc))
        case ("INT32_EXP", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int32Op.Exp, e1, e2, loc))
        case ("INT32_AND", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int32Op.And, e1, e2, loc))
        case ("INT32_OR", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int32Op.Or, e1, e2, loc))
        case ("INT32_XOR", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int32Op.Xor, e1, e2, loc))
        case ("INT32_SHL", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int32Op.Shl, e1, e2, loc))
        case ("INT32_SHR", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int32Op.Shr, e1, e2, loc))
        case ("INT32_EQ", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int32Op.Eq, e1, e2, loc))
        case ("INT32_NEQ", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int32Op.Neq, e1, e2, loc))
        case ("INT32_LT", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int32Op.Lt, e1, e2, loc))
        case ("INT32_LE", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int32Op.Le, e1, e2, loc))
        case ("INT32_GT", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int32Op.Gt, e1, e2, loc))
        case ("INT32_GE", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int32Op.Ge, e1, e2, loc))
        case ("INT64_NEG", e1 :: Nil, Nil) => Validation.Success(Expr.Unary(SemanticOp.Int64Op.Neg, e1, loc))
        case ("INT64_NOT", e1 :: Nil, Nil) => Validation.Success(Expr.Unary(SemanticOp.Int64Op.Not, e1, loc))
        case ("INT64_ADD", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int64Op.Add, e1, e2, loc))
        case ("INT64_SUB", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int64Op.Sub, e1, e2, loc))
        case ("INT64_MUL", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int64Op.Mul, e1, e2, loc))
        case ("INT64_DIV", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int64Op.Div, e1, e2, loc))
        case ("INT64_REM", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int64Op.Rem, e1, e2, loc))
        case ("INT64_EXP", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int64Op.Exp, e1, e2, loc))
        case ("INT64_AND", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int64Op.And, e1, e2, loc))
        case ("INT64_OR", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int64Op.Or, e1, e2, loc))
        case ("INT64_XOR", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int64Op.Xor, e1, e2, loc))
        case ("INT64_SHL", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int64Op.Shl, e1, e2, loc))
        case ("INT64_SHR", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int64Op.Shr, e1, e2, loc))
        case ("INT64_EQ", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int64Op.Eq, e1, e2, loc))
        case ("INT64_NEQ", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int64Op.Neq, e1, e2, loc))
        case ("INT64_LT", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int64Op.Lt, e1, e2, loc))
        case ("INT64_LE", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int64Op.Le, e1, e2, loc))
        case ("INT64_GT", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int64Op.Gt, e1, e2, loc))
        case ("INT64_GE", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.Binary(SemanticOp.Int64Op.Ge, e1, e2, loc))
        case ("CHANNEL_GET", e1 :: Nil, Nil) => Validation.Success(Expr.GetChannel(e1, loc))
        case ("CHANNEL_PUT", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.PutChannel(e1, e2, loc))
        case ("CHANNEL_NEW", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.NewChannel(e1, e2, loc))
        case ("ARRAY_NEW", e1 :: e2 :: e3 :: Nil, Nil) => Validation.Success(Expr.ArrayNew(e1, e2, e3, loc))
        case ("ARRAY_LENGTH", e1 :: Nil, Nil) => Validation.Success(Expr.ArrayLength(e1, loc))
        case ("ARRAY_LOAD", e1 :: e2 :: Nil, Nil) => Validation.Success(Expr.ArrayLoad(e1, e2, loc))
