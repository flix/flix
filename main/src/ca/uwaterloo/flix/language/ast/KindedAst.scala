...
object KindedAst {
  ...
  object Expr {
    ...
    case class AscribeType(exp: Expr, expectedType: Type, tvar: Type.Var, loc: SourceLocation) extends Expr

    case class AscribeEff(exp: Expr, expectedEff: Type, tvar: Type.Var, loc: SourceLocation) extends Expr
