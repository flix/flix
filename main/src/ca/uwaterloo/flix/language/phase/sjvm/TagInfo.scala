...
import ca.uwaterloo.flix.language.ast.{PType, RRefType, RType, Symbol}
...
case class TagInfo(sym: Symbol.EnumSym, tag: String, tparams: List[RType[_ <: PType]], enumType: RRefType.REnum, tagType: RType[_ <: PType]) {
  /**
