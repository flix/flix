...
import ca.uwaterloo.flix.language.errors.TypeError.{MismatchedTypes, UnexpectedArgumentToDef, UnexpectedType}
  ...
  test("Incremental.04") {
    flix.addSourceCode(FileA,
      s"""
         ...
         |
         |""".stripMargin)
    expectError[UnexpectedArgumentToDef](flix.compile())
  }
