...
object TraitEnvironment {
  ...
  def entail(tconstrs0: List[TraitConstraint], tconstr: TraitConstraint, traitEnv: Map[Symbol.TraitSym, Ast.TraitContext], eqEnv: ListMap[Symbol.AssocTypeSym, Ast.AssocTypeDef])(implicit scope: Scope, flix: Flix): Validation[Unit, UnificationError] = {
  ...
  /**
    ...
    */
  def entails(tconstr1: TraitConstraint, tconstr2: TraitConstraint, traitEnv: Map[Symbol.TraitSym, Ast.TraitContext]): Boolean = {
  ...
  /**
    ...
    */
  def holds(tconstr: TraitConstraint, traitEnv: Map[Symbol.TraitSym, Ast.TraitContext], eqEnv: ListMap[Symbol.AssocTypeSym, Ast.AssocTypeDef])(implicit scope: Scope, flix: Flix): Boolean = {
  ...
  /**
    ...
    */
  private def simplify(tconstrs0: List[TraitConstraint], traitEnv: Map[Symbol.TraitSym, Ast.TraitContext], eqEnv: ListMap[Symbol.AssocTypeSym, Ast.AssocTypeDef])(implicit scope: Scope, flix: Flix): List[TraitConstraint] = {
  ...
  /**
    ...
    */
  def reduce(tconstrs0: List[TraitConstraint], traitEnv: Map[Symbol.TraitSym, Ast.TraitContext], eqEnv: ListMap[Symbol.AssocTypeSym, Ast.AssocTypeDef])(implicit scope: Scope, flix: Flix): Validation[List[TraitConstraint], UnificationError] = {
  ...
  /**
    ...
    */
  private def toHeadNormalForm(tconstr: TraitConstraint, traitEnv: Map[Symbol.TraitSym, TraitContext], eqEnv: ListMap[Symbol.AssocTypeSym, Ast.AssocTypeDef])(implicit scope: Scope, flix: Flix): Validation[List[TraitConstraint], UnificationError] = {
  ...
  /**
    ...
    */
  private def byInst(tconstr: TraitConstraint, traitEnv: Map[Symbol.TraitSym, Ast.TraitContext], eqEnv: ListMap[Symbol.AssocTypeSym, Ast.AssocTypeDef])(implicit scope: Scope, flix: Flix): Validation[List[TraitConstraint], UnificationError] = tconstr match {
  ...
  /**
    ...
    *
    */
  private def bySuper(tconstr: TraitConstraint, traitEnv: Map[Symbol.TraitSym, Ast.TraitContext]): List[TraitConstraint] = {
