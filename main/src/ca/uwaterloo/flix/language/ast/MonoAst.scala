...
object MonoAst {
  ...
  object Expr {
    ...
    case class ApplyDef(sym: Symbol.DefnSym, exps: Nel[Expr], itpe: Type, tpe: Type, eff: Type, loc: SourceLocation) extends Expr

    case class ApplyLocalDef(sym: Symbol.VarSym, exps: Nel[Expr], tpe: Type, eff: Type, loc: SourceLocation) extends Expr

    case class ApplyOp(sym: Symbol.OpSym, exps: Nel[Expr], tpe: Type, eff: Type, loc: SourceLocation) extends Expr
