...
object ResolvedAstPrinter {
  ...
  private def print(exp0: ResolvedAst.Expr): DocAst.Expr = exp0 match {
    ...
    case Expr.While(exp1, exp2, _) => DocAst.Expr.While(print(exp1), print(exp2))
    ...
    case Expr.ExtMatch(_, _, _) => DocAst.Expr.Unknown
    ...
    case Expr.ExtTag(_, _, _) => DocAst.Expr.Unknown // TODO: Ext-Variants
