...
object ParsedAst {
  ...
  object Expression {
    ...
    /**
      ...
      * @param sp2   the position of the last character in the expression.
      */
    case class TypeMatch(sp1: SourcePosition, exp: ParsedAst.Expression, ret: Option[Type], rules: Seq[ParsedAst.MatchTypeRule], sp2: SourcePosition) extends ParsedAst.Expression
