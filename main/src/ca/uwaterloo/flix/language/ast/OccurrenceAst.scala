...
object OccurrenceAst {
  ...
  case class Enum(mod: Ast.Modifiers, sym: Symbol.EnumSym, cases: Map[Name.Tag, OccurrenceAst.Case], tpeDeprecated: Type, loc: SourceLocation)
  ...
  object Expression {
    ...
    case class Let(sym: Symbol.VarSym, exp1: OccurrenceAst.Expression, exp2: OccurrenceAst.Expression, occur: Occur, purity: Purity, tpe: Type, loc: SourceLocation) extends OccurrenceAst.Expression
