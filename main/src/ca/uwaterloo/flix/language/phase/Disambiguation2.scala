...
object Disambiguation2 {
  ...
  /**
    ...
    */
  def resolve(tpe0: NamedAst.Type, ns0: Name.NName, program: NamedAst.Program): Result[Type, TypeError] = tpe0 match {
  ...
  /**
    ...
    */
  def resolve(sc0: NamedAst.Scheme, ns0: Name.NName, program: NamedAst.Program): Result[Scheme, TypeError] = {
  ...
  /**
    * Resolves the given type `tpe0` in the given namespace `ns0`.
    */
  def resolve(tpes0: List[NamedAst.Type], ns0: Name.NName, program: NamedAst.Program): Result[List[Type], TypeError] = {
