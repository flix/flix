...
object Library {
  ...
  val StandardLibrary = List(
    ...
    "Net/SimpleHttp.flix" -> LocalResource.get("/src/library/Net/SimpleHttp.flix"),
    "Net/SimpleHttp/Response.flix" -> LocalResource.get("/src/library/Net/SimpleHttp/Response.flix"),
