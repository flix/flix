...
object TypedAst {
  ...
  object Expression {
    ...
    case class VectorSlice(base: TypedAst.Expression, beginIndex: Int, endIndex: TypedAst.Expression, tpe: Type, eff: ast.Eff, loc: SourceLocation) extends TypedAst.Expression
