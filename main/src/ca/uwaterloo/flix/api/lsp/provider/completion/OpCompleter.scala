...
object OpCompleter {
  /**
    ...
    */
  def getCompletions(name: SourceName, pos: Position, qn: Name.QName, range: Range, ap: AnchorPosition, scp: LocalScope)(implicit root: TypedAst.Root, flix: Flix): Iterable[OpCompletion] = {
