...
object LiftedAst {
  ...
  object Expression {
    ...
    case class Let(sym: Symbol.VarSym, exp1: LiftedAst.Expression, exp2: LiftedAst.Expression,purity: Purity, tpe: Type, loc: SourceLocation) extends LiftedAst.Expression
