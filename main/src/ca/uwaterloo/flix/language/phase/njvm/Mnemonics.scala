  ...
  class F[T](mv: MethodVisitor, ct: NJvmType.Reference) {
    ...
    def boxPrim[S](jt: NJvmType): F[S] = {
      jt match {
        ...
        case PrimChar => emitInvoke(JvmModifier.InvokeStatic, JvmName.Character.toInternalName, "valueOf", Nil, Reference(JvmName.Character))
        case PrimByte => emitInvoke(JvmModifier.InvokeStatic, JvmName.Byte.toInternalName, "valueOf", Nil, Reference(JvmName.Byte))
        case PrimShort => emitInvoke(JvmModifier.InvokeStatic, JvmName.Short.toInternalName, "valueOf", Nil, Reference(JvmName.Short))
        case PrimInt => emitInvoke(JvmModifier.InvokeStatic, JvmName.Integer.toInternalName, "valueOf", Nil, Reference(JvmName.Integer))
        case PrimLong => emitInvoke(JvmModifier.InvokeStatic, JvmName.Long.toInternalName, "valueOf", Nil, Reference(JvmName.Long))
        case PrimFloat => emitInvoke(JvmModifier.InvokeStatic, JvmName.Float.toInternalName, "valueOf", Nil, Reference(JvmName.Float))
        case PrimDouble => emitInvoke(JvmModifier.InvokeStatic, JvmName.Double.toInternalName, "valueOf", Nil, Reference(JvmName.Double))
        case _ => throw InternalCompilerException(s"Unexpected type $jt")
      }
      this.asInstanceOf[F[S]]
    }
