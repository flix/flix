...
object Type {
  ...
  /**
    * An AST node that represents the closure environment type.
    *
    * Closure environments can only be generated by the compiler, and are used to implement closures.
    */
  case object ClosureEnv extends Type
}