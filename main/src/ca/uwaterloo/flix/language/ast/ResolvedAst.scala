...
object ResolvedAst {
  ...
  case class Spec(doc: Ast.Doc, ann: List[ResolvedAst.Annotation], mod: Ast.Modifiers, tparams: List[ResolvedAst.TypeParam], fparams: List[ResolvedAst.FormalParam], sc: Scheme, tpe: Type, eff: Type, scSc: ScopeScheme, loc: SourceLocation)
  ...
  object Expression {
    ...
    case class RefWithRegion(exp1: ResolvedAst.Expression, exp2: ResolvedAst.Expression, tpe: Type.Var, evar: Type.Var, loc: SourceLocation) extends ResolvedAst.Expression
    ...
    case class Assign(exp1: ResolvedAst.Expression, exp2: ResolvedAst.Expression, evar: Type.Var, loc: SourceLocation) extends ResolvedAst.Expression
  ...
  case class FormalParam(sym: Symbol.VarSym, mod: Ast.Modifiers, tpe: Type, scSc: Option[ScopeScheme], loc: SourceLocation)
