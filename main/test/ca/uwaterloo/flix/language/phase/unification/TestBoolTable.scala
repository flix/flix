...
class TestBoolTable extends FunSuite {
  ...
  test("Minimize.Var1AndVar2AndVar3AndVar4.01") {
    assertResult(expected = Conj(Var(0), Conj(Var(1), Conj(Var(2), Var(3)))))(actual = minimizeFormula(Conj(Conj(Var(0), Var(1)), Conj(Var(2), Var(3)))))
  }

  test("Minimize.Var1AndVar2AndVar3AndVar4.02") {
    assertResult(expected = Conj(Var(0), Conj(Var(1), Conj(Var(2), Var(3)))))(actual = minimizeFormula(Conj(Conj(Var(3), Var(2)), Conj(Var(0), Var(1)))))
  }

  test("Minimize.Var1AndVar2AndVar3AndVar4.03") {
    assertResult(expected = Disj(Var(0), Disj(Var(1), Disj(Var(2), Var(3)))))(actual = minimizeFormula(Disj(Disj(Var(0), Var(1)), Disj(Var(2), Var(3)))))
  }

  test("Minimize.Var1AndVar2AndVar3AndVar4.04") {
    assertResult(expected = Conj(Disj(Neg(Var(0)), Neg(Var(1))), Disj(Neg(Var(2)), Neg(Var(3)))))(actual = minimizeFormula(Neg(Disj(Conj(Neg(Neg(Var(0))), Neg(Neg(Var(1)))), Conj(Neg(Neg(Var(2))), Neg(Neg(Var(3))))))))
  }
