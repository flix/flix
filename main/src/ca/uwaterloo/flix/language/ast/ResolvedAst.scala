...
object ResolvedAst {
  ...
  object Declaration {
    ...
    case class External(doc: Option[Ast.Documentation], ident: Name.Ident, params: List[ResolvedAst.FormalParam], tpe: ResolvedAst.Type, loc: SourceLocation) extends ResolvedAst.Declaration
