    ...
    case Denotation.Latticenal =>
      tpeOpt match {
        ...
        case Some(tpe) =>
          ...
          val innerApply = LoweredAst.Expr.ApplyDef(Ast.DefSymUse(latticeSym, loc), List(LoweredAst.Expr.Cst(Constant.Unit, Type.Unit, loc)), latticeType, unboxedDenotationType, Type.Pure, loc)
