...
sealed trait Completion {
  /**
    ...
    */
  def toCompletionItem(undefinedNameContext: UndefinedNameContext)(implicit flix: Flix): CompletionItem = this match {
