...
object ResolvedAst {
  ...
  object Expression {
    ...
    case class InvokeMethod(method: Method, receiverClass: java.lang.Class[_], exp: ResolvedAst.Expression, args: List[ResolvedAst.Expression], loc: SourceLocation) extends ResolvedAst.Expression
