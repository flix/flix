...
object NamedAst {
  ...
  object Declaration {
    ...
    case class Namespace(ann: Annotations, sym: Symbol.ModuleSym, usesAndImports: List[UseOrImport], decls: List[Declaration], loc: SourceLocation) extends Declaration
