...
object Namer {
  ...
  /**
    ...
    */
  private def visitConstraint(c0: WeededAst.Constraint, outerEnv: Map[String, Symbol.VarSym], uenv0: UseEnv, tenv0: Map[String, Symbol.TypeVarSym])(implicit flix: Flix): Validation[NamedAst.Constraint, NameError] = c0 match {
  ...
  /**
    ...
    */
  private def casesOf(cases: Map[Name.Tag, WeededAst.Case], uenv0: UseEnv, tenv0: Map[String, Symbol.TypeVarSym])(implicit flix: Flix): Validation[Map[Name.Tag, NamedAst.Case], NameError] = {
  ...
  /**
    ...
    */
  private def visitClass(clazz: WeededAst.Declaration.Class, uenv0: UseEnv, tenv0: Map[String, Symbol.TypeVarSym], ns0: Name.NName)(implicit flix: Flix): Validation[NamedAst.Class, NameError] = clazz match {
  ...
  /**
    ...
    */
  private def visitInstance(instance: WeededAst.Declaration.Instance, uenv0: UseEnv, tenv0: Map[String, Symbol.TypeVarSym], ns0: Name.NName)(implicit flix: Flix): Validation[NamedAst.Instance, NameError] = instance match {
  ...
  /**
    ...
    */
  private def visitTypeConstraint(tconstr: WeededAst.TypeConstraint, uenv0: UseEnv, tenv0: Map[String, Symbol.TypeVarSym], ns0: Name.NName)(implicit flix: Flix): Validation[NamedAst.TypeConstraint, NameError] = tconstr match {
  ...
  /**
    ...
    */
  private def visitSig(sig: WeededAst.Declaration.Sig, uenv0: UseEnv, tenv0: Map[String, Symbol.TypeVarSym], ns0: Name.NName, classIdent: Name.Ident, classSym: Symbol.ClassSym, classTparam: NamedAst.TypeParam)(implicit flix: Flix): Validation[NamedAst.Sig, NameError] = sig match {
  ...
  /**
    ...
    */
  private def visitDef(decl0: WeededAst.Declaration.Def, uenv0: UseEnv, tenv0: Map[String, Symbol.TypeVarSym], ns0: Name.NName, addedTconstrs: List[NamedAst.TypeConstraint], addedQuantifiers: List[Type.UnkindedVar])(implicit flix: Flix): Validation[NamedAst.Def, NameError] = decl0 match {
  ...
  /**
    ...
    */
  private def visitExp(exp0: WeededAst.Expression, env0: Map[String, Symbol.VarSym], uenv0: UseEnv, tenv0: Map[String, Symbol.TypeVarSym])(implicit flix: Flix): Validation[NamedAst.Expression, NameError] = exp0 match {
  ...
  /**
    ...
    */
  private def visitHeadPredicate(head: WeededAst.Predicate.Head, outerEnv: Map[String, Symbol.VarSym], headEnv0: Map[String, Symbol.VarSym], ruleEnv0: Map[String, Symbol.VarSym], uenv0: UseEnv, tenv0: Map[String, Symbol.TypeVarSym])(implicit flix: Flix): Validation[NamedAst.Predicate.Head, NameError] = head match {
  ...
  /**
    ...
    */
  private def visitBodyPredicate(body: WeededAst.Predicate.Body, outerEnv: Map[String, Symbol.VarSym], headEnv0: Map[String, Symbol.VarSym], ruleEnv0: Map[String, Symbol.VarSym], uenv0: UseEnv, tenv0: Map[String, Symbol.TypeVarSym])(implicit flix: Flix): Validation[NamedAst.Predicate.Body, NameError] = body match {
  ...
  /**
    ...
    */
  private def visitType(tpe0: WeededAst.Type, uenv0: UseEnv, tenv0: Map[String, Symbol.TypeVarSym])(implicit flix: Flix): Validation[NamedAst.Type, NameError] = tpe0 match {
    ...
    case WeededAst.Type.Var(ident, loc) =>
      ...
      if (isSuspiciousTypeVarName(ident.name)) {
        ...
        NamedAst.Type.Var(Symbol.freshTypeVarSym(None, loc), loc).toSuccess
      } else {
  ...
  /**
    ...
    */
  private def freeVarsInTenv(tpe0: WeededAst.Type, tenv: Map[String, Symbol.TypeVarSym]): List[Name.Ident] = {
  ...
  /**
    ...
    */
  private def visitAnnotation(ann: WeededAst.Annotation, env0: Map[String, Symbol.VarSym], uenv0: UseEnv, tenv0: Map[String, Symbol.TypeVarSym])(implicit flix: Flix): Validation[NamedAst.Annotation, NameError] = ann match {
  ...
  /**
    ...
    */
  private def visitAttribute(attr: WeededAst.Attribute, uenv0: UseEnv, tenv0: Map[String, Symbol.TypeVarSym])(implicit flix: Flix): Validation[NamedAst.Attribute, NameError] = attr match {
  ...
  /**
    ...
    */
  private def visitFormalParam(fparam: WeededAst.FormalParam, uenv0: UseEnv, tenv0: Map[String, Symbol.TypeVarSym])(implicit flix: Flix): Validation[NamedAst.FormalParam, NameError] = fparam match {
  ...
  /**
    ...
    */
  private def getFormalParams(fparams0: List[WeededAst.FormalParam], uenv0: UseEnv, tenv0: Map[String, Symbol.TypeVarSym])(implicit flix: Flix): Validation[List[NamedAst.FormalParam], NameError] = {
  ...
  /**
    ...
    */
  private def getTypeParamsFromFormalParams(tparams0: WeededAst.TypeParams, fparams: List[WeededAst.FormalParam], tpe: WeededAst.Type, allowElision: Boolean, uenv: UseEnv, tenv: Map[String, Symbol.TypeVarSym])(implicit flix: Flix): NamedAst.TypeParams = {
    tparams0 match {
  ...
  /**
    ...
    */
  private def getImplicitTypeParamsFromFormalParams(fparams: List[WeededAst.FormalParam], tpe: WeededAst.Type, tenv: Map[String, Symbol.TypeVarSym])(implicit flix: Flix): NamedAst.TypeParams = {
  ...
  /**
    ...
    */
  private def getTypeEnv(tparams0: List[NamedAst.TypeParam]): Map[String, Symbol.TypeVarSym] = {
