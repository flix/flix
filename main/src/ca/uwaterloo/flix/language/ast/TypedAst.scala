...
object TypedAst {
  ...
  object Expression {
    ...
    case class RecordExtension(base: TypedAst.Expression, label: Name.Ident, exp: TypedAst.Expression, tpe: Type, eff: ast.Eff, loc: SourceLocation) extends TypedAst.Expression
