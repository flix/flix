...
sealed trait Completion {
  ...
  def toCompletionItem(context: CompletionContext)(implicit flix: Flix): CompletionItem = this match {
    ...
    case Completion.PredicateCompletion(name, arity, detail) =>
      ...
      CompletionItem(
        label = s"$name/$arity",
        sortText = Priority.toSortText(name, Priority.lower),
    ...
    case Completion.SnippetCompletion(name, snippet, documentation) =>
      CompletionItem(label = name,
        sortText = Priority.toSortText(name, Priority.high),
    ...
    case Completion.VarCompletion(sym, tpe) =>
      CompletionItem(label = sym.text,
        sortText = Priority.toSortText(sym.text, Priority.low),
    ...
    case Completion.MatchCompletion(enm, completion) =>
      ...
      CompletionItem(label = label,
        sortText = Priority.toSortText(label, Priority.lower),
    ...
    case Completion.InstanceCompletion(trt, completion) =>
      ...
      CompletionItem(label = s"$traitSym[...]",
        sortText = Priority.toSortText(traitSym.toString, Priority.highest),
        textEdit = TextEdit(context.range, completion),
    ...
    case Completion.ModCompletion(modSym) =>
      ...
      CompletionItem(
        label = name,
        sortText = Priority.toSortText(name, Priority.lowest),
        textEdit = TextEdit(context.range, name),
    ...
    case Completion.FieldCompletion(ident, field) =>
      ...
      CompletionItem(
        label = label,
        sortText = Priority.toSortText(label, Priority.lowest),
    ...
    case Completion.StructFieldCompletion(field, loc, tpe) =>
      CompletionItem(
        label = field,
        sortText = Priority.toSortText(field, Priority.lowest),
