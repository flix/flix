...
object CompleteProvider {
  ...
  private def getSnippetCompletionItems(): List[CompletionItem] = List(
    ...
    CompletionItem("import", "import ${1:method}", None, Some("import code snippet for method call"), CompletionItemKind.Snippet, InsertTextFormat.Snippet, Nil),
    CompletionItem("import", "import new ${1:object} as ${2:name}", None, Some("import code snippet for new object"), CompletionItemKind.Snippet, InsertTextFormat.Snippet, Nil),
    CompletionItem("import", "import get ${1:field} as ${2:name}", None, Some("import code snippet to get field"), CompletionItemKind.Snippet, InsertTextFormat.Snippet, Nil),
    CompletionItem("import", "import set ${1:field} as ${2:name}", None, Some("import code snippet to set field"), CompletionItemKind.Snippet, InsertTextFormat.Snippet, Nil),
    ...
    CompletionItem("let", "let ${1:name} = ${2:exp};\n", None, Some("code snippet for let"), CompletionItemKind.Snippet, InsertTextFormat.PlainText, Nil),
    CompletionItem("let*", "let* ${1:name} = ${2:exp};\n", None, Some("code snippet for let*"), CompletionItemKind.Snippet, InsertTextFormat.PlainText, Nil),
    ...
    CompletionItem("rel", "rel ${1:name}(${2:x}: ${3:type}, ${4:y}: ${5:type})", None, Some("code snippet to declare predicate symbol"), CompletionItemKind.Snippet, InsertTextFormat.Snippet, Nil),
    CompletionItem("select", "select {\n    $1\n}", None, Some("code snippet for select"), CompletionItemKind.Snippet, InsertTextFormat.Snippet, Nil),
