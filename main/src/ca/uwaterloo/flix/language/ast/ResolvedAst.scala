...
object ResolvedAst {
  ...
  object Expression {
    ...
    case class Cast(exp: ResolvedAst.Expression, declaredType: Option[UnkindedType], declaredEff: Option[UnkindedType], loc: SourceLocation) extends ResolvedAst.Expression
