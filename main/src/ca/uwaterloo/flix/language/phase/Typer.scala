...
object Typer extends Phase[ResolvedAst.Root, TypedAst.Root] {
  ...
  /**
    ...
    */
  private def mkClassEnv(instances: MultiMap[Symbol.ClassSym, ResolvedAst.Instance]): MultiMap[Symbol.ClassSym, Ast.Instance] = {
  ...
  /**
    ...
    * Returns [[Err]] if a definition fails to type check.
    */
  private def visitInstances(root: ResolvedAst.Root, classEnv: MultiMap[Symbol.ClassSym, Ast.Instance])(implicit flix: Flix): Validation[MultiMap[Symbol.ClassSym, TypedAst.Instance], TypeError] = {
  ...
  /**
    ...
    */
  private def visitDefn(defn: ResolvedAst.Def, root: ResolvedAst.Root, classEnv: MultiMap[Symbol.ClassSym, Ast.Instance])(implicit flix: Flix): Validation[TypedAst.Def, TypeError] =
  ...
  /**
    ...
    * Returns [[Err]] if a definition fails to type check.
    */
  private def visitDefs(root: ResolvedAst.Root, classEnv: MultiMap[Symbol.ClassSym, Ast.Instance])(implicit flix: Flix): Validation[Map[Symbol.DefnSym, TypedAst.Def], TypeError] = {
