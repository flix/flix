...
object TraitEnvironment {
  ...
  def entail(tconstrs0: List[Ast.TraitConstraint], tconstr: Ast.TraitConstraint, traitEnv: TraitEnv, eqEnv: ListMap[Symbol.AssocTypeSym, Ast.AssocTypeDef])(implicit scope: Scope, flix: Flix): Validation[Unit, UnificationError] = {
  ...
  /**
    ...
    */
  def entails(tconstr1: Ast.TraitConstraint, tconstr2: Ast.TraitConstraint, traitEnv: TraitEnv): Boolean = {
  ...
  /**
    ...
    */
  def holds(tconstr: Ast.TraitConstraint, traitEnv: TraitEnv, eqEnv: ListMap[Symbol.AssocTypeSym, Ast.AssocTypeDef])(implicit scope: Scope, flix: Flix): Boolean = {
  ...
  /**
    ...
    */
  private def simplify(tconstrs0: List[Ast.TraitConstraint], traitEnv: TraitEnv, eqEnv: ListMap[Symbol.AssocTypeSym, Ast.AssocTypeDef])(implicit scope: Scope, flix: Flix): List[Ast.TraitConstraint] = {
  ...
  /**
    ...
    */
  def reduce(tconstrs0: List[Ast.TraitConstraint], traitEnv: TraitEnv, eqEnv: ListMap[Symbol.AssocTypeSym, Ast.AssocTypeDef])(implicit scope: Scope, flix: Flix): Validation[List[Ast.TraitConstraint], UnificationError] = {
  ...
  /**
    ...
    */
  private def toHeadNormalForm(tconstr: Ast.TraitConstraint, traitEnv: TraitEnv, eqEnv: ListMap[Symbol.AssocTypeSym, Ast.AssocTypeDef])(implicit scope: Scope, flix: Flix): Validation[List[Ast.TraitConstraint], UnificationError] = {
