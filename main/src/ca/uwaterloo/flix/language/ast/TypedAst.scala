...
object TypedAst {
  ...
  object Expression {
    ...
    case class MatchType(exp: TypedAst.Expression, rules: List[TypedAst.MatchTypeRule], tpe: Type, pur: Type, eff: Type, loc: SourceLocation) extends TypedAst.Expression
