...
object TypedAst {
  ...
  object Expression {
    ...
    case class TypeMatch(exp: TypedAst.Expression, ret: Option[Type], rules: List[TypedAst.MatchTypeRule], tpe: Type, pur: Type, eff: Type, loc: SourceLocation) extends TypedAst.Expression
