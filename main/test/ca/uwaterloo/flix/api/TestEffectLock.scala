...
import ca.uwaterloo.flix.api.CompilerConstants.VirtualTestFile
...
class TestEffectLock extends AnyFunSuite with TestUtils {
  ...
  test("serialization.01") {
    ...
    val expected = SDef(List.empty, "fun", scheme, VirtualTestFile)
  ...
  test("serialization.03") {
    ...
    val scheme = SScheme(List.empty, List.empty, List.empty, tpe)
    val expected = SDef(List.empty, "toUnit", scheme, VirtualTestFile)
  ...
  test("serialization.04") {
    ...
    val scheme = SScheme(List.empty, List.empty, List.empty, tpe)
    val expected = SDef(List.empty, "answer", scheme, VirtualTestFile)
  ...
  test("serialization.05") {
    ...
    val expected = SDef(List(), "toInt32", scheme, VirtualTestFile)
  ...
  test("serialization.06") {
    ...
    val expected = SDef(List.empty, "pretty", scheme, VirtualTestFile)
  ...
  test("serialization.07") {
    ...
    val expected = SDef(List.empty, "prettyPrint", scheme, VirtualTestFile)
  ...
  test("serialization.10") {
    ...
    val expected = SDef(List.empty, "h", scheme, VirtualTestFile)
