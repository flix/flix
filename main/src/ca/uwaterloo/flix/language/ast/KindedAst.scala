...
object KindedAst {
  ...
  object Predicate {
    ...
    object Body {
      ...
      case class Atom(pred: Name.Pred, den: Denotation, polarity: Ast.Polarity, fixity: Ast.Fixity, terms: List[KindedAst.Predicate.BodyTerm], tvar: ast.Type.Var, loc: SourceLocation) extends KindedAst.Predicate.Body
    ...
    case class BodyTerm(sym: Symbol.VarSym, tvar: Type.Var, loc: SourceLocation)
