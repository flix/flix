...
object ParsedAst {
  ...
  object Expression {
    ...
    case class IfThenElseStar(sp1: SourcePosition, cond: ParsedAst.Type, exp1: ParsedAst.Expression, exp2: ParsedAst.Expression, sp2: SourcePosition) extends ParsedAst.Expression
