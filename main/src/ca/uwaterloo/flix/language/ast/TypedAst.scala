...
object TypedAst {
  ...
  object Expr {
    ...
    case class NewObject(name: String, clazz: java.lang.Class[?], targs: List[Type], tpe: Type, eff: Type, constructors: List[JvmConstructor], methods: List[JvmMethod], loc: SourceLocation) extends Expr
