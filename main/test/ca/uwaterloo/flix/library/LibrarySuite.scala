...
class LibrarySuite extends Suites(
  ...
  new FlixTest("TestUnsafeBox", "main/test/ca/uwaterloo/flix/library/TestUnsafeBox.flix")(Options.TestWithLibrary),
  ...
  new FlixTest("TestGetOpt", "main/test/ca/uwaterloo/flix/library/TestGetOpt.flix")(Options.TestWithLibrary),
