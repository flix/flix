...
object ResolvedAst {
  ...
  object Expression {
    ...
    case class Let(mod: Ast.Modifiers, sym: Symbol.VarSym, exp1: ResolvedAst.Expression, exp2: ResolvedAst.Expression, loc: SourceLocation) extends ResolvedAst.Expression
