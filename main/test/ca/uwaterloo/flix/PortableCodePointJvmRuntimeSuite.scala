...
class PortableCodePointJvmRuntimeSuite extends AnyFunSuite {
  ...
  private val testDir = Paths.get("main/test/flix/portable_codepoint")

  test("portable-codepoint-jvm-runtime") {
    val flix = mkFlix()
