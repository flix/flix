...
object Instances {
  ...
  /**
    ...
    */
  private def findInstanceForType(tpe: Type, tconstrs: List[TraitConstraint], econstrs: List[EqualityConstraint], trt: Symbol.TraitSym, root: TypedAst.Root)(implicit flix: Flix): Option[(Instance, Substitution)] = {
    ...
    case TypedAst.Instance(_, _, _, trt, tpe, tconstrs, econstrs, _, _, _, _) =>
      ...
      superTraits.foreach {
        superTrait =>
          ...
          findInstanceForType(tpe, tconstrs, econstrs, superTrait, root) match {
