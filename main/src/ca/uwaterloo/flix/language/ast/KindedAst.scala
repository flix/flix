...
object KindedAst {
  ...
  object Expr {
    ...
    case class FixpointQueryWithProvenance(exps: List[Expr], select: Predicate.Head, withh: List[Name.Pred], tvar: Type.Var, evar: Type.Var, loc: SourceLocation) extends Expr
