...
object TypedAst {
  ...
  object Expr {
    ...
    case class StructGet(exp: Expr, field: Symbol.StructFieldSym, tpe: Type, eff: Type, loc: SourceLocation) extends Expr

    case class StructPut(exp1: Expr, field: Symbol.StructFieldSym, exp2: Expr, tpe: Type, eff: Type, loc: SourceLocation) extends Expr
