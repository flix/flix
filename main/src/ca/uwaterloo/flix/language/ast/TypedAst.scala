...
object TypedAst {
  ...
  object Expression {
    ...
    case class Let(mod: Ast.Modifiers, sym: Symbol.VarSym, exp1: TypedAst.Expression, exp2: TypedAst.Expression, tpe: Type, eff: Type, loc: SourceLocation) extends TypedAst.Expression
