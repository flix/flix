...
object NamedAst {
  ...
  object Declaration {
    ...
    case class AssocTypeSig(doc: Doc, mod: Modifiers, sym: Symbol.AssocTypeSym, tparam: TypeParam, tparams: List[TypeParam], kind: Kind, tpe: Option[Type], loc: SourceLocation) extends Declaration

    case class AssocTypeDef(doc: Doc, mod: Modifiers, ident: Name.Ident, arg: Type, args: List[Type], tpe: Type, loc: SourceLocation) extends Declaration
