...
class TestTyper extends AnyFunSuite with TestUtils {
  ...
  // --- Java Generic Type Checking: Positive Tests ---

  test("Test.JavaGenericCheck.Pos.01") {
    val input =
      raw"""
  ...
  test("Test.JavaGenericCheck.Pos.02") {
    val input =
      raw"""
           |import java.util.ArrayList
           |def f(): Bool \ IO =
  ...
  test("Test.JavaGenericCheck.Pos.03") {
    val input =
      raw"""
           |import java.util.ArrayList
           |def f(): Bool \ IO =
  ...
  test("Test.JavaGenericCheck.Pos.04") {
    val input =
      raw"""
           |import java.util.ArrayList
           |def f(): Bool \ IO =
  ...
  test("Test.JavaGenericCheck.Pos.05") {
    val input =
      raw"""
           |import java.util.ArrayList
           |def f(): Bool \ IO =
  ...
  test("Test.JavaGenericCheck.Pos.06") {
    val input =
      raw"""
  ...
  test("Test.JavaGenericCheck.Pos.07") {
    val input =
      raw"""
           |import java.util.HashMap
           |def f(): Unit \ IO =
  ...
  test("Test.JavaGenericCheck.Pos.08") {
    val input =
      raw"""
  ...
  test("Test.JavaGenericCheck.Pos.09") {
    val input =
      raw"""
  ...
  test("Test.JavaGenericCheck.Pos.10") {
    val input =
      raw"""
  ...
  test("Test.JavaGenericCheck.Pos.11") {
    val input =
      raw"""
           |import java.util.ArrayList
           |def f(): Unit \ IO =
  ...
  test("Test.JavaGenericCheck.Pos.12") {
    val input =
      raw"""
           |import java.util.ArrayList
           |def f(): String \ IO =
  ...
  test("Test.JavaGenericCheck.Pos.13") {
    val input =
      raw"""
           |import java.util.HashMap
           |def f(): Unit \ IO =
  ...
  test("Test.JavaGenericCheck.Pos.14") {
    val input =
      raw"""
           |import java.util.HashMap
  ...
  test("Test.JavaGenericCheck.Pos.15") {
    val input =
      raw"""
           |import java.util.HashMap
           ...
           |def f(): Unit \ IO =
           |    let m: HashMap[String, Int32] = new HashMap();
           |    let _v: Collection[Int32] = m.values();
           |    ()
         """.stripMargin
    val result = check(input, Options.TestWithLibMin)
    expectSuccess(result)
  ...
  test("Test.JavaGenericCheck.Pos.16") {
    val input =
      raw"""
           |import java.util.ArrayList
           ...
           |def f(): Unit \ IO =
           |    let l: ArrayList[String] = new ArrayList();
           |    let _it: Iterator[String] = l.iterator();
           |    ()
         """.stripMargin
    val result = check(input, Options.TestWithLibMin)
    expectSuccess(result)
  ...
  test("Test.JavaGenericCheck.Pos.17") {
    val input =
      raw"""
           |import java.util.ArrayList
           ...
           |    let l: ArrayList[String] = new ArrayList();
           |    l.add("a");
           |    let _sub: JList[String] = l.subList(0, 1);
           |    ()
         """.stripMargin
    val result = check(input, Options.TestWithLibMin)
    expectSuccess(result)
  ...
  test("Test.JavaGenericCheck.Pos.18") {
    val input =
      raw"""
           |import java.util.ArrayList
           |def f(): Int32 \ IO =
  ...
  test("Test.JavaGenericCheck.Pos.19") {
    val input =
      raw"""
           |import java.util.ArrayList
           |def f(): Bool \ IO =
  ...
  test("Test.JavaGenericCheck.Pos.20") {
    val input =
      raw"""
           |import java.util.LinkedList
           |def f(): String \ IO =
