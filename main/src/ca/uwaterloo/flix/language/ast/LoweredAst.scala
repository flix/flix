...
object LoweredAst {
  ...
  object Expr {
    ...
    case class ApplyDef(sym: Symbol.DefnSym, exps: List[Expr], map: Map[Symbol.KindedTypeVarSym, Type], itpe: Type, tpe: Type, eff: Type, loc: SourceLocation) extends Expr
    ...
    case class ApplySig(sym: Symbol.SigSym, exps: List[Expr], sel: Type, map: Map[Symbol.KindedTypeVarSym, Type], itpe: Type, tpe: Type, eff: Type, loc: SourceLocation) extends Expr
