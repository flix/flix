...
object NamedAst {
  ...
  object Declaration {
    ...
    case class Enum(doc: Option[Ast.Documentation], sym: Symbol.EnumSym, tparams: List[NamedAst.TypeParam], cases: Map[String, NamedAst.Case], sc: ast.Scheme, loc: SourceLocation) extends NamedAst.Declaration
