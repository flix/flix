...
object ResolvedAst {
  ...
  object Expr {
    ...
    case class StructGet(sym: Symbol.StructSym, e: Expr, f: Symbol.StructFieldSym, loc: SourceLocation) extends Expr

    case class StructPut(sym: Symbol.StructSym, exp1: Expr, name: Symbol.StructFieldSym, exp2: Expr, loc: SourceLocation) extends Expr
