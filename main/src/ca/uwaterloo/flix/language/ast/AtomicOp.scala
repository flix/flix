...
object AtomicOp {
  ...
  case class StructPut(sym: Symbol.StructSym, idx: Int, field: Symbol.StructFieldSym) extends AtomicOp

  case class StructGet(sym: Symbol.StructSym, idx: Int, field: Symbol.StructFieldSym) extends AtomicOp
