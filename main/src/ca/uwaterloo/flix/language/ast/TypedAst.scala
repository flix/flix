...
object TypedAst {
  ...
  object Expression {
    ...
    case class Scope(sym: Symbol.VarSym, regSym: Symbol.RegionSym, exp: TypedAst.Expression, tpe: Type, pur: Type, eff: Type, loc: SourceLocation) extends TypedAst.Expression
