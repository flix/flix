...
object NamedAst {
  ...
  object Expression {
    ...
    case class FixpointFold(constraints: NamedAst.Expression, init: NamedAst.Expression, f: NamedAst.Expression, tpe: MonoType, loc: SourceLocation) extends NamedAst.Expression
