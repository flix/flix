...
object KindedAst {
  ...
  object Predicate {
    ...
    object Body {
      ...
      case class Atom(pred: Name.Pred, den: Denotation, polarity: Ast.Polarity, fixity: Ast.Fixity, terms: List[Symbol.VarSym], tvar: ast.Type.Var, loc: SourceLocation) extends KindedAst.Predicate.Body
