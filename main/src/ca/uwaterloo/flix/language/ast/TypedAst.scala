...
object TypedAst {
  ...
  object Expression {
    ...
    case class ArrayStore(exp1: TypedAst.Expression, exps2: List[TypedAst.Expression], exp3: TypedAst.Expression, tpe: Type, eff: ast.Eff, loc: SourceLocation) extends TypedAst.Expression
