...
object SafetyError {
  ...
  /**
    ...
    */
  case class IllegalEntryPointSignature(loc: SourceLocation) extends SafetyError {
  ...
  /**
    ...
    * @param loc the location of the defn.
    */
  case class IllegalExportNamespace(loc: SourceLocation) extends SafetyError {
  ...
  /**
    ...
    * @param loc the location of the defn.
    */
  case class NonPublicExport(loc: SourceLocation) extends SafetyError {
  ...
  /**
    ...
    * @param loc the location of the defn.
    */
  case class IllegalExportName(loc: SourceLocation) extends SafetyError {
  ...
  /**
    ...
    * @param loc the location of the defn.
    */
  case class IllegalExportEffect(loc: SourceLocation) extends SafetyError {
  ...
  /**
    ...
    * @param loc the location of the defn.
    */
  case class IllegalExportPolymorphism(loc: SourceLocation) extends SafetyError {
  ...
  /**
    ...
    */
  case class IllegalExportType(t: Type, loc: SourceLocation) extends SafetyError {
