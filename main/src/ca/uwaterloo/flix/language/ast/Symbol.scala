...
object Symbol {
  ...
  def freshVarSym()(implicit flix: Flix): VarSym = {
    new VarSym(flix.genSym.freshId(), "tmp", Type.freshTypeVarXXXDeprecated(), SourceLocation.Unknown)
  }
  ...
  def freshVarSym(ident: Name.Ident)(implicit flix: Flix): VarSym = {
    new VarSym(flix.genSym.freshId(), ident.name, Type.freshTypeVarXXXDeprecated(), ident.loc)
  }
  ...
  def freshVarSym(text: String)(implicit flix: Flix): VarSym = {
    new VarSym(flix.genSym.freshId(), text, Type.freshTypeVarXXXDeprecated(), SourceLocation.Unknown)
  }
