...
object ParsedAst {
  ...
  object Declaration {
    ...
    /**
      ...
      * @param sp1          the position of the first character in the declaration.
      * @param ident        the name of the enum.
      * @param restriction  the type parameter the describes the restriction of tags.
      * @param tparams      the type parameters.
      * @param derives      the derivations of the enum.
      * @param cases        the cases of the enum.
      * @param sp2          the position of the last character in the declaration.
      */
    case class RestrictableEnum(doc: ParsedAst.Doc, ann: Seq[ParsedAst.Annotation], mod: Seq[ParsedAst.Modifier], sp1: SourcePosition, ident: Name.Ident, restriction: TypeParam, tparams: ParsedAst.TypeParams, tpe: Option[ParsedAst.Type], derives: Seq[Name.QName], cases: Option[Seq[ParsedAst.RestrictableCase]], sp2: SourcePosition) extends ParsedAst.Declaration
