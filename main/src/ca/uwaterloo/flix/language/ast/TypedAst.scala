...
object TypedAst {
  ...
  object Declaration {
    ...
    case class Definition(doc: Option[Ast.Documentation], ann: Ast.Annotations, mod: Ast.Modifiers, sym: Symbol.DefnSym, tparams: List[TypedAst.TypeParam], fparams: List[TypedAst.FormalParam], exp: TypedAst.Expression, tpe: Type, loc: SourceLocation) extends TypedAst.Declaration
  ...
  object Expression {
    ...
    case class Unit(loc: SourceLocation) extends TypedAst.Expression {
      ...
      final def eff: Effect = Effect.Pure
    }
    ...
    case class Wild(tpe: Type, eff: Effect, loc: SourceLocation) extends TypedAst.Expression

    case class Var(sym: Symbol.VarSym, tpe: Type, eff: Effect, loc: SourceLocation) extends TypedAst.Expression

    case class Ref(sym: Symbol.DefnSym, tpe: Type, eff: Effect, loc: SourceLocation) extends TypedAst.Expression

    case class Hook(hook: Ast.Hook, tpe: Type, eff: Effect, loc: SourceLocation) extends TypedAst.Expression

    case class Lambda(args: List[TypedAst.FormalParam], body: TypedAst.Expression, tpe: Type, eff: Effect, loc: SourceLocation) extends TypedAst.Expression

    case class Apply(exp: TypedAst.Expression, args: List[TypedAst.Expression], tpe: Type, eff: Effect, loc: SourceLocation) extends TypedAst.Expression

    case class Unary(op: UnaryOperator, exp: TypedAst.Expression, tpe: Type, eff: Effect, loc: SourceLocation) extends TypedAst.Expression

    case class Binary(op: BinaryOperator, exp1: TypedAst.Expression, exp2: TypedAst.Expression, tpe: Type, eff: Effect, loc: SourceLocation) extends TypedAst.Expression

    case class Let(sym: Symbol.VarSym, exp1: TypedAst.Expression, exp2: TypedAst.Expression, tpe: Type, eff: Effect, loc: SourceLocation) extends TypedAst.Expression

    case class LetRec(sym: Symbol.VarSym, exp1: TypedAst.Expression, exp2: TypedAst.Expression, tpe: Type, eff: Effect, loc: SourceLocation) extends TypedAst.Expression

    case class IfThenElse(exp1: TypedAst.Expression, exp2: TypedAst.Expression, exp3: TypedAst.Expression, tpe: Type, eff: Effect, loc: SourceLocation) extends TypedAst.Expression

    case class Match(exp: TypedAst.Expression, rules: List[TypedAst.MatchRule], tpe: Type, eff: Effect, loc: SourceLocation) extends TypedAst.Expression

    case class Switch(rules: List[(TypedAst.Expression, TypedAst.Expression)], tpe: Type, eff: Effect, loc: SourceLocation) extends TypedAst.Expression

    case class Tag(sym: Symbol.EnumSym, tag: String, exp: TypedAst.Expression, tpe: Type, eff: Effect, loc: SourceLocation) extends TypedAst.Expression

    case class Tuple(elms: List[TypedAst.Expression], tpe: Type, eff: Effect, loc: SourceLocation) extends TypedAst.Expression

    case class Existential(fparam: TypedAst.FormalParam, exp: TypedAst.Expression, eff: Effect, loc: SourceLocation) extends TypedAst.Expression {
      def tpe: Type = Type.Bool
    }

    case class Universal(fparam: TypedAst.FormalParam, exp: TypedAst.Expression, eff: Effect, loc: SourceLocation) extends TypedAst.Expression {
      def tpe: Type = Type.Bool
    }

    case class NativeConstructor(constructor: Constructor[_], args: List[TypedAst.Expression], tpe: Type, eff: Effect, loc: SourceLocation) extends TypedAst.Expression

    case class NativeField(field: Field, tpe: Type, eff: Effect, loc: SourceLocation) extends TypedAst.Expression

    case class NativeMethod(method: Method, args: List[TypedAst.Expression], tpe: Type, eff: Effect, loc: SourceLocation) extends TypedAst.Expression

    case class UserError(tpe: Type, eff: Effect, loc: SourceLocation) extends TypedAst.Expression
