...
object SimplifiedAst {
  ...
  object Expression {
    ...
    case class FixpointFold(pred: SimplifiedAst.PredicateWithParam, init: Symbol.VarSym, f: Symbol.VarSym, constraints: Symbol.VarSym, tpe: Type, loc: SourceLocation) extends SimplifiedAst.Expression
