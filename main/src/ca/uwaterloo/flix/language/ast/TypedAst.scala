...
object TypedAst {
  ...
  object Expr {
    ...
    case class ApplyDef(symUse: DefSymUse, exps: List[Expr], map: Map[Symbol.KindedTypeVarSym, Type], itpe: Type, tpe: Type, eff: Type, loc: SourceLocation) extends Expr
    ...
    case class ApplySig(symUse: SigSymUse, exps: List[Expr], sel: Type, map: Map[Symbol.KindedTypeVarSym, Type], itpe: Type, tpe: Type, eff: Type, loc: SourceLocation) extends Expr
