...
object SimplifiedAst {
  ...
  object Expression {
    ...
    case class Let(sym: Symbol.VarSym, exp1: SimplifiedAst.Expression, exp2: SimplifiedAst.Expression, purity: Purity, tpe: Type, loc: SourceLocation) extends SimplifiedAst.Expression
