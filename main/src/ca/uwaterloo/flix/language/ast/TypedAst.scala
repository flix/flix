...
object TypedAst {
  ...
  object Predicate {
    ...
    object Body {
      ...
      case class Atom(pred: Name.Pred, den: Denotation, polarity: Polarity, fixity: Fixity, provenance: Provenance, terms: List[Pattern], tpe: Type, loc: SourceLocation) extends Predicate.Body
