...
object TypedAst {
  ...
  object Predicate {
    ...
    object Body {
      ...
      case class Atom(pred: Name.Pred, den: Denotation, polarity: Ast.Polarity, fixity: Ast.Fixity, terms: List[Symbol.VarSym], tpe: Type, loc: SourceLocation) extends TypedAst.Predicate.Body
