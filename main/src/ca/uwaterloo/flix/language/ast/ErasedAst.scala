...
object ErasedAst {
  ...
  object Expression {
    ...
    case class Closure(sym: Symbol.DefnSym, letrecs: List[Symbol.VarSym], freeVars: List[FreeVar], fnMonoType: MonoType, tpe: MonoType, loc: SourceLocation) extends ErasedAst.Expression
