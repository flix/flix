...
object TraitEnvironment {
  ...
  def entail(tconstrs0: List[TraitConstraint], tconstr: TraitConstraint, traitEnv: TraitEnv, eqEnv: ListMap[Symbol.AssocTypeSym, Ast.AssocTypeDef])(implicit scope: Scope, listener: SolverListener, flix: Flix): Validation[Unit, UnificationError] = {
  ...
  /**
    ...
    */
  def holds(tconstr: TraitConstraint, traitEnv: TraitEnv, eqEnv: ListMap[Symbol.AssocTypeSym, Ast.AssocTypeDef])(implicit scope: Scope, listener: SolverListener, flix: Flix): Boolean = {
  ...
  /**
    ...
    */
  private def simplify(tconstrs0: List[TraitConstraint], traitEnv: TraitEnv, eqEnv: ListMap[Symbol.AssocTypeSym, Ast.AssocTypeDef])(implicit scope: Scope, listener: SolverListener, flix: Flix): List[TraitConstraint] = {
  ...
  /**
    ...
    */
  def reduce(tconstrs0: List[TraitConstraint], traitEnv: TraitEnv, eqEnv: ListMap[Symbol.AssocTypeSym, Ast.AssocTypeDef])(implicit scope: Scope, listener: SolverListener, flix: Flix): Validation[List[TraitConstraint], UnificationError] = {
  ...
  /**
    ...
    */
  private def toHeadNormalForm(tconstr: TraitConstraint, traitEnv: TraitEnv, eqEnv: ListMap[Symbol.AssocTypeSym, Ast.AssocTypeDef])(implicit scope: Scope, listener: SolverListener, flix: Flix): Validation[List[TraitConstraint], UnificationError] = {
  ...
  /**
    ...
    */
  private def byInst(tconstr: TraitConstraint, traitEnv: TraitEnv, eqEnv: ListMap[Symbol.AssocTypeSym, Ast.AssocTypeDef])(implicit scope: Scope, listener: SolverListener, flix: Flix): Validation[List[TraitConstraint], UnificationError] = tconstr match {
