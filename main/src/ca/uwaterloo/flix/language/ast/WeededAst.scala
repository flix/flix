...
object WeededAst {
  ...
  object Predicate {
    ...
    object Body {
      ...
      case class Atom(pred: Name.Pred, den: Denotation, polarity: Ast.Polarity, fixity: Ast.Fixity, terms: List[Name.Ident], loc: SourceLocation) extends WeededAst.Predicate.Body
