...
class TestFastSetUnification extends AnyFunSuite with TestUtils {
  ...
  test("Fixpoint.Ast.Datalog.predSymsOf$29898") {
    val l = List(
      Univ ~ (Var(97799) & Var(97816) & Var(97819) & Var(97847) & Var(97859)),
  ...
  test("Fixpoint.Ast.Datalog.toString$299997") {
    val l = List(
      Univ ~ (Var(100987) & (Var(101022) & Var(101116))),
  ...
  test("Fixpoint.Phase.IndexSelection.queryOp") {
    val l = List(
      Univ ~ ((Var(66558) & (Var(66568) & (Var(66628) & (Var(66633) & (Var(66638) & (Var(66641) & (Var(66644) & (Var(66657) & Var(66660))))))))) & (Var(66668) & (Var(66673) & (Var(66678) & (Var(66684) & Var(66689)))))),
      Var(66556) ~ Univ,
      Var(66558) ~ Var(66556),
      Var(66564) ~ Univ,
  ...
  test("Fixpoint.Phase.Simplifier.simplifyOp") {
    val l = List(
      Univ ~ ((Var(58593) & (Var(58598) & Var(58601))) & (Var(58635) & (Var(58667) & Var(58683)))),
      Var(58568) ~ Univ,
      Var(58576) ~ Univ,
      Var(58579) ~ Univ,
  ...
  test("Fixpoint.Solver.solveWithStratification") {
    val l = List(
      Univ ~ (Var(65701) & (Var(65724) & Var(65762))),
  ...
  test("Custom.Elems.Disjoint02") {
    val l = List(
      (Elem(0) | Elem(1)) ~ ((Elem(0) | Elem(1) | Elem(2)) & Term.Compl(Elem(2)))
    )
    val s = solveAll(l).get
    verify(s, l)
  }
  ...
  test("Custom.Minus01") {
    val l = List(
      (Cst(0) & Term.Compl(Cst(1))) ~ ((Cst(0) | Cst(1)) & Term.Compl(Cst(1)))
    )
    val s = solveAll(l).get
    verify(s, l)
  }
