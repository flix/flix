...
object ParsedAst {
  ...
  object Expression {
    ...
    /**
      ...
      * @param sp2  the position of the last character in the expression.
      */
    case class LetMatchStar(sp1: SourcePosition, mod: Seq[ParsedAst.Modifier], pat: ParsedAst.Pattern, tpe: Option[ParsedAst.Type], exp1: ParsedAst.Expression, exp2: ParsedAst.Expression, sp2: SourcePosition) extends ParsedAst.Expression
