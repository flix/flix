...
object Layout {
  ...
  /** Width contribution of the optional mono / opt / inl / cls per-phase count columns (4 × separator + width). */
  private val CountsColWidth: Int = 4 * (1 + 4)
  ...
  /**
    ...
    * columns by passing `showCounts` (mono / opt / inl / cls) and `showCns`
