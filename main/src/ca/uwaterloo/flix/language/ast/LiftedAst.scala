...
object LiftedAst {
  ...
  object Expression {
    ...
    case class NewObject(clazz: java.lang.Class[_], tpe: Type, purity: Purity, methods: List[LiftedAst.JvmMethod], loc: SourceLocation) extends LiftedAst.Expression
  ...
  case class JvmMethod(ident: Name.Ident, fparams: List[LiftedAst.FormalParam], exp: LiftedAst.Expression, retTpe: Type, purity: Purity, loc: SourceLocation)
