...
object DesugaredAst {
  ...
  object Declaration {
    ...
    case class Instance(doc: Ast.Doc, ann: Annotations, mod: Ast.Modifiers, trt: Name.QName, tpe: Type, tconstrs: List[TraitConstraint], assocs: List[Declaration.AssocTypeDef], defs: List[Declaration.Def], loc: SourceLocation) extends Declaration
