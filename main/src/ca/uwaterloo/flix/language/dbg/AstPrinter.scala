...
object AstPrinter {
  ...
  implicit object DebugLoweredAst2 extends Debug[LoweredAst2.Root] {
    override def emit(phase: String, root: LoweredAst2.Root)(implicit flix: Flix): Unit =
//      TODO: Will not do. Should be dummy implementation...
      ()
  }
