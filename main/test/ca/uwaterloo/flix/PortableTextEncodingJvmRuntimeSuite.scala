...
class PortableTextEncodingJvmRuntimeSuite extends AnyFunSuite {
  ...
  private val testDir = Paths.get("main/test/flix/portable_text_encoding")

  test("portable-text-encoding-jvm-runtime") {
    val flix = mkFlix()
