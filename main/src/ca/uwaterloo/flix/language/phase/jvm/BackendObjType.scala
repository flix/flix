...
sealed trait BackendObjType {
  ...
  /** `[] --> return` */
  protected def nullarySuperConstructor(superClass: ConstructorMethod)(implicit f: AsmWrapper): Unit = {
    thisLoad()
  ...
  /** `[] --> return` */
  protected def singletonStaticConstructor(thisConstructor: ConstructorMethod, singleton: StaticField)(implicit f: AsmWrapper): Unit = {
    NEW(this.jvmName)
    DUP()
...
object BackendObjType {
  ...
  case object Unit extends BackendObjType {
    ...
    /** `[] --> return String` */
    private def toStringIns(implicit f: AsmWrapper): Unit = {
      pushString("()")
      ARETURN()
    }
  ...
  case class Lazy(tpe: BackendType) extends BackendObjType {
    ...
    /** `[] --> return` */
    private def constructorIns(implicit f: AsmWrapper): Unit =
    ...
    /** `[] --> return tpe` */
    private def forceIns(implicit f: AsmWrapper): Unit = {
      def unlockLock(): Unit = {
        thisLoad()
        GETFIELD(LockField)
  ...
  case class Tuple(elms: List[BackendType]) extends BackendObjType {
    ...
    private def getIndexField(i: Int)(implicit f: AsmWrapper): Unit = {
  ...
  case class Struct(elms: List[BackendType]) extends BackendObjType {
    ...
    /** `[] --> [this.index(i).xString()]` */
    private def getIndexString(i: Int)(implicit f: AsmWrapper): Unit = {
      val field = IndexField(i)
      thisLoad()
      GETFIELD(field)
      xToString(field.tpe)
  ...
  case object Tagged extends BackendObjType {
    ...
    /** [...] -> [..., tagName] */
    def mkTagName(name: String)(implicit f: AsmWrapper): Unit = pushString(JvmOps.getTagName(name))

    /** [..., tagName1, tagName2] --> [..., tagName1 == tagName2] */
    def eqTagName()(implicit f: AsmWrapper): Unit = {
  ...
  case class Arrow(args: List[BackendType], result: BackendType) extends BackendObjType {
    ...
    sealed trait FunctionInterface {
      ...
      /**
        ...
        * These methods should do the same as a non-tail call in genExpression.
        */
      def functionIns(implicit f: AsmWrapper): Unit = this match {
        case ObjFunction =>
          thisLoad()
          DUP()
          ALOAD(1)
  ...
  case object RecordEmpty extends BackendObjType {
    ...
    private def toTailStringIns(implicit f: AsmWrapper): Unit = {
    ...
    private def throwUnsupportedExc(implicit f: AsmWrapper): Unit = {
  ...
  case class RecordExtend(value: BackendType) extends BackendObjType {
    ...
    private def lookupFieldIns(implicit f: AsmWrapper): Unit = {
      caseOnLabelEquality {
        case TrueBranch =>
          thisLoad()
          ARETURN()
    ...
    private def restrictFieldIns(implicit f: AsmWrapper): Unit = {
      caseOnLabelEquality {
        case TrueBranch =>
          thisLoad()
          GETFIELD(RestField)
    ...
    /**
      ...
      */
    private def caseOnLabelEquality(cases: Branch => Unit)(implicit f: AsmWrapper): Unit = {
      thisLoad()
      GETFIELD(LabelField)
      ALOAD(1)
  ...
  case object Global extends BackendObjType {
    ...
    private def staticConstructorIns(implicit f: AsmWrapper): Unit = {
    ...
    private def newIdIns(implicit f: AsmWrapper): Unit = {
    ...
    private def getArgsIns(implicit f: AsmWrapper): Unit = {
      GETSTATIC(ArgsField)
      ARRAYLENGTH()
      ANEWARRAY(String.jvmName)
      ASTORE(0)
    ...
    private def setArgsIns(implicit f: AsmWrapper): Unit = {
      ALOAD(0)
      ARRAYLENGTH()
      ANEWARRAY(String.jvmName)
      ASTORE(1)
    ...
    private def arrayCopy()(implicit f: AsmWrapper): Unit = {
  ...
  case object Region extends BackendObjType {
    ...
    private def spawnIns(implicit f: AsmWrapper): Unit = {
    ...
    private def exitIns(implicit f: AsmWrapper): Unit = {
    ...
    private def reportChildExceptionIns(implicit f: AsmWrapper): Unit = {
      thisLoad()
      ALOAD(1)
      PUTFIELD(ChildExceptionField)
      thisLoad()
    ...
    private def reThrowChildExceptionIns(implicit f: AsmWrapper): Unit = {
      thisLoad()
    ...
    private def runOnExitIns(implicit f: AsmWrapper): Unit = {
      thisLoad()
      GETFIELD(OnExitField)
      ALOAD(1)
  ...
  case object UncaughtExceptionHandler extends BackendObjType {
    ...
    private def uncaughtExceptionsIns(implicit f: AsmWrapper): Unit = {
      thisLoad()
  ...
  case object Main extends BackendObjType {
    ...
    private def mainIns(sym: Symbol.DefnSym)(implicit f: AsmWrapper): Unit = {
  ...
  case class Namespace(ns: List[String]) extends BackendObjType {
    ...
    private def shimIns(defn: ReducedAst.Def)(implicit f: AsmWrapper): Unit = {
  ...
  case object Result extends BackendObjType {
    ...
    /**
      ...
      */
    def unwindThunk()(implicit f: AsmWrapper): Unit = {
      whileLoop(Condition.NE) {
        DUP()
    ...
    /**
      ...
      */
    private def handleSuspension(pc: Int, newFrame: Unit => Unit, setPc: Unit => Unit)(implicit f: AsmWrapper): Unit = {
      DUP()
    ...
    /**
      ...
      */
    def unwindThunkToValue(pc: Int, newFrame: Unit => Unit, setPc: Unit => Unit)(implicit f: AsmWrapper): Unit = {
      unwindThunk()
    ...
    /**
      ...
      */
    def unwindSuspensionFreeThunkToType(tpe: BackendType, errorHint: String, loc: SourceLocation)(implicit f: AsmWrapper): Unit = {
      unwindThunk()
    ...
    /**
      ...
      * side effect: crashes on suspensions
      */
    def unwindSuspensionFreeThunk(errorHint: String, loc: SourceLocation)(implicit f: AsmWrapper): Unit = {
      unwindThunk()
      crashIfSuspension(errorHint, loc)
    ...
    /**
      ...
      */
    def crashIfSuspension(errorHint: String, loc: SourceLocation)(implicit f: AsmWrapper): Unit = {
      DUP()
      INSTANCEOF(Suspension.jvmName)
      ifCondition(Condition.NE) {
  ...
  case object Frame extends BackendObjType {
    ...
    private def staticApplyIns(implicit f: AsmWrapper): Unit = {
  ...
  case object Thunk extends BackendObjType {
    ...
    private def runIns(implicit f: AsmWrapper): Unit = {
      thisLoad()
  ...
  case object Frames extends BackendObjType {
    ...
    def pushImplementation(implicit f: AsmWrapper): Unit = {
  ...
  case object FramesCons extends BackendObjType {
    ...
    private def reverseOntoIns(implicit f: AsmWrapper): Unit = {
  ...
  case object Resumption extends BackendObjType {
    ...
    private def staticRewindIns(implicit f: AsmWrapper): Unit = {
  ...
  case object ResumptionCons extends BackendObjType {
    ...
    private def rewindIns(implicit f: AsmWrapper): Unit = {
      withName(1, Value.toTpe) { v =>
        thisLoad()
        GETFIELD(SymField)
        thisLoad()
  ...
  case object Handler extends BackendObjType {
    ...
    private def installHandlerIns(implicit f: AsmWrapper): Unit = {
  ...
  case class ResumptionWrapper(tpe: BackendType) extends BackendObjType {
    ...
    private def invokeIns(implicit f: AsmWrapper): Unit = {
      thisLoad()
      ...
      DUP()
      thisLoad()
      f.mv.visitFieldInsn(Opcodes.GETFIELD, this.jvmName.toInternalName, "arg0", tpe.toErased.toDescriptor)
    ...
    private def uniqueIns(implicit f: AsmWrapper): Unit = {
      thisLoad()
      ARETURN()
    }
  }
