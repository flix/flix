...
object TypedAst {
  ...
  object Expression {
    ...
    case class NewChannel(exp1: TypedAst.Expression, exp2: TypedAst.Expression, tpe: Type, elmTpe: Type, pur: Type, eff: Type, loc: SourceLocation) extends TypedAst.Expression
