...
object ResolvedAst {
  ...
  object Expression {
    ...
    case class Without(exp: ResolvedAst.Expression, effs: List[Ast.EffectSymUse], loc: SourceLocation) extends ResolvedAst.Expression
    ...
    case class NewObject(clazz: java.lang.Class[_], methods: List[JvmMethod], loc: SourceLocation) extends ResolvedAst.Expression
