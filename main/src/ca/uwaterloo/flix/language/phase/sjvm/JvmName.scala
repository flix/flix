...
object JvmName {
   ...
   */
  def getMethodDescriptor(argumentTypes: List[JvmName], resultType: Option[JvmName]): String = {
    // Descriptor of result
    val resultDescriptor = resultType.fold(voidDescriptor)(_.toDescriptor)
  ...
  def getMethodDescriptor(argumentTypes: List[JvmName], resultType: JvmName): String =
    getMethodDescriptor(argumentTypes, Some(resultType))

  def getMethodDescriptor(argumentType: JvmName, resultType: Option[JvmName]): String =
    getMethodDescriptor(List(argumentType), resultType)

  def getMethodDescriptor(argumentType: JvmName, resultType: JvmName): String =
    getMethodDescriptor(List(argumentType), Some(resultType))
