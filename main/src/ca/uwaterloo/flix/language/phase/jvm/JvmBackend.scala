  ...
  def run(root: Root)(implicit flix: Flix): CompilationResult = flix.phaseNoPrinter("JvmBackend") {
    ...
    val allClasses = flix.subphase("CodeGen") {
      ...
      val requiredTypes = Set(
        MonoType.Arrow(List(MonoType.Bool), MonoType.Object, Purity.Pure), // by resumptionWrappers
        MonoType.Arrow(List(MonoType.Char), MonoType.Object, Purity.Pure), // by resumptionWrappers
        MonoType.Arrow(List(MonoType.Int8), MonoType.Object, Purity.Pure), // by resumptionWrappers
        MonoType.Arrow(List(MonoType.Int16), MonoType.Object, Purity.Pure), // by resumptionWrappers
        MonoType.Arrow(List(MonoType.Int32), MonoType.Object, Purity.Pure), // by resumptionWrappers
        MonoType.Arrow(List(MonoType.Int64), MonoType.Object, Purity.Pure), // by resumptionWrappers
        MonoType.Arrow(List(MonoType.Float32), MonoType.Object, Purity.Pure), // by resumptionWrappers
        MonoType.Arrow(List(MonoType.Float64), MonoType.Object, Purity.Pure), // by resumptionWrappers
        MonoType.Arrow(List(MonoType.Object), MonoType.Object, Purity.Pure), // by resumptionWrappers
      )
