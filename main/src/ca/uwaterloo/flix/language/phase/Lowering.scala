...
object Lowering {
  ...
  /**
    * Determines whether the par expression should spawn a thread for the given expression `exp`.
    *
    * Returns false if `exp` is a literal, def or a variable. Returns true otherwise.
    */
