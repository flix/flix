...
object NamedAst {
  ...
  case class Class(doc: Ast.Doc, mod: Ast.Modifiers, sym: Symbol.ClassSym, tparam: NamedAst.TypeParam, superclasses: List[Name.QName], sigs: List[NamedAst.Sig], loc: SourceLocation)
