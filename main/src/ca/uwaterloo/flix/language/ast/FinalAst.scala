...
object FinalAst {
  ...
  object Expression {
    ...
    case class Closure(sym: Symbol.DefnSym, letrecs: List[Symbol.VarSym], freeVars: List[FreeVar], fnMonoType: MonoType, tpe: MonoType, loc: SourceLocation) extends FinalAst.Expression
    ...
    case class LetRec(varSym: Symbol.VarSym, defSym: Symbol.DefnSym, exp1: FinalAst.Expression, exp2: FinalAst.Expression, tpe: MonoType, loc: SourceLocation) extends FinalAst.Expression
