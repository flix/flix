...
/**
  ...
  * @param sctx         The optional syntactic context.
  ...
  */
case class CompletionContext(uri: String, pos: Position, range: Range, sctx: Option[SyntacticContext], word: String, previousWord: String, prefix: String, errors: List[CompilationMessage])
