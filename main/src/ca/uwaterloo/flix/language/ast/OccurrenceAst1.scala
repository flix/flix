...
object OccurrenceAst1 {
  ...
  case class Def(ann: Annotations, mod: Modifiers, sym: Symbol.DefnSym, cparams: List[(OccurrenceAst1.FormalParam, Occur)], fparams: List[(OccurrenceAst1.FormalParam, Occur)], exp: OccurrenceAst1.Expr, context: DefContext, tpe: MonoType, loc: SourceLocation)
