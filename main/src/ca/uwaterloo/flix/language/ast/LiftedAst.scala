...
object LiftedAst {
  ...
  object Expression {
    ...
    case class Closure(sym: Symbol.DefnSym, letrecs: List[Symbol.VarSym], freeVars: List[FreeVar], tpe: Type, loc: SourceLocation) extends LiftedAst.Expression
    ...
    case class LetRec(varSym: Symbol.VarSym, defSym: Symbol.DefnSym, exp1: LiftedAst.Expression, exp2: LiftedAst.Expression, tpe: Type, loc: SourceLocation) extends LiftedAst.Expression
