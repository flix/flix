...
object WeededAst {
  ...
  object Declaration {
    ...
    case class Class(ident: Name.Ident, tparam: WeededAst.TypeParams, signatures: List[WeededAst.Declaration.Sig], loc: SourceLocation) extends WeededAst.Declaration
