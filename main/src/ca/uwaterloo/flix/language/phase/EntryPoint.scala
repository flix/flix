...
object EntryPoint {
  ...
  /**
    ...
    */
  private def checkEntryPointArgs(defn: TypedAst.Def, classEnv: Map[Symbol.ClassSym, Ast.ClassContext], root: TypedAst.Root)(implicit flix: Flix): Validation[Unit, List[EntryPointError]] = defn match {
