...
//  }
  def mkNot(tpe0: Type): Type = Type.mkNot(tpe0, tpe0.loc)
...
//  }
  def mkAnd(tpe1: Type, tpe2: Type): Type = Type.mkAnd(tpe1, tpe2, tpe1.loc)
...
//  }
  def mkOr(tpe1: Type, tpe2: Type): Type = Type.mkOr(tpe1, tpe2, tpe1.loc)
