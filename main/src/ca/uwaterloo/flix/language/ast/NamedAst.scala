...
object NamedAst {
  ...
  case class StructField(name: Name.Ident, tpe: Type, loc: SourceLocation)
  ...
  object Expr {
    ...
    case class StructNew(qname: QName, exps: List[(Name.Ident, Expr)], region: Expr, loc: SourceLocation) extends Expr
