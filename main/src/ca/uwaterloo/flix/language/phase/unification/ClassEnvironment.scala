...
object ClassEnvironment {
  ...
  def entail(tconstrs0: List[Ast.TypeConstraint], tconstr: Ast.TypeConstraint, instances: MultiMap[Symbol.ClassSym, Ast.Instance])(implicit flix: Flix): Boolean = {
  ...
  /**
    ...
    */
  private def simplify(tconstrs0: List[Ast.TypeConstraint], instances: MultiMap[Symbol.ClassSym, Ast.Instance])(implicit flix: Flix): List[Ast.TypeConstraint] = {
  ...
  /**
    ...
    */
  private def reduce(tconstrs0: List[Ast.TypeConstraint], instances: MultiMap[Symbol.ClassSym, Ast.Instance])(implicit flix: Flix): Result[List[Ast.TypeConstraint], UnificationError] = {
    for {
  ...
  /**
    ...
    */
  private def toHeadNormalForm(tconstr: Ast.TypeConstraint, instances: MultiMap[Symbol.ClassSym, Ast.Instance])(implicit flix: Flix): Result[List[Ast.TypeConstraint], UnificationError] = {
  ...
  /**
    ...
    */
  private def byInst(tconstr: Ast.TypeConstraint, instances: MultiMap[Symbol.ClassSym, Ast.Instance])(implicit flix: Flix): Result[List[Ast.TypeConstraint], UnificationError] = {
    val matchingInstances = instances(tconstr.sym).toList

    def tryInst(inst: Ast.Instance): Result[List[Ast.TypeConstraint], UnificationError] = {
      for {
