...
object ReducedAstPrinter {
  ...
  def print(e: ReducedAst.Expr): DocAst.Expression = e match {
    ...
    case Expr.Let(sym, exp1, exp2, tpe, _, _) => DocAst.Expression.Let(printVarSym(sym), Some(TypePrinter.print(exp1.tpe)), print(exp1), print(exp2))
    case Expr.LetRec(varSym, _, _, exp1, exp2, tpe, _, _) => DocAst.Expression.LetRec(printVarSym(varSym), Some(TypePrinter.print(exp1.tpe)), print(exp1), print(exp2))
