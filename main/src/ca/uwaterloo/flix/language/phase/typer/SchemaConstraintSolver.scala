...
object SchemaConstraintSolver {
  ...
  /**
    ...
    */
  private def pivot(row: Type, hdLabel: Name.Pred, hdTpe: Type, tvars: Set[Symbol.KindedTypeVarSym])(implicit scope: RegionScope, renv: RigidityEnv, flix: Flix): Option[(Type, Substitution)] = row match {
