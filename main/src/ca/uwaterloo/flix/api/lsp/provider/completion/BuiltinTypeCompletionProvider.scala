...
object BuiltinTypeCompletionProvider {
  ...
  def getBuiltinTypes(priority: String => String)(implicit context: CompletionContext, root: TypedAst.Root): Iterable[Completion] = {
    if (root == null) {
      return Nil
    }
