...
object KindedAst {
  ...
  case class Instance(doc: Doc, ann: Annotations, mod: Modifiers, symUse: TraitSymUse, tpe: Type, tconstrs: List[TraitConstraint], assocs: List[AssocTypeDef], defs: List[Def], ns: Name.NName, loc: SourceLocation)
