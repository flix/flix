...
object Library {
  ...
  val StandardLibrary: List[(String, String)] = List(
    ...
    "Net/HttpInteraction.flix" -> LocalResource.get("/src/library/Net/HttpInteraction.flix"),
    ...
    "Net/RecordedBody.flix" -> LocalResource.get("/src/library/Net/RecordedBody.flix"),
    "Net/RecordedOutcome.flix" -> LocalResource.get("/src/library/Net/RecordedOutcome.flix"),
    "Net/RecordedRequest.flix" -> LocalResource.get("/src/library/Net/RecordedRequest.flix"),
