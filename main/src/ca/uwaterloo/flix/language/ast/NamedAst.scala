...
object NamedAst {
  ...
  case class Spec(doc: Ast.Doc, ann: List[NamedAst.Annotation], mod: Ast.Modifiers, tparams: List[NamedAst.TypeParam], fparams: List[NamedAst.FormalParam], sc: NamedAst.Scheme, retTpe: Type, eff: Type, scSc: ScopeScheme, loc: SourceLocation)
  ...
  case class FormalParam(sym: Symbol.VarSym, mod: Ast.Modifiers, tpe: NamedAst.Type, scSc: Option[ScopeScheme], loc: SourceLocation)
