...
object OccurrenceAst {
  ...
  object Expression {
    ...
    case class NewObject(clazz: java.lang.Class[_], tpe: Type, purity: Purity, methods: List[OccurrenceAst.JvmMethod], loc: SourceLocation) extends OccurrenceAst.Expression
  ...
  case class JvmMethod(ident: Name.Ident, fparams: List[OccurrenceAst.FormalParam], closure: OccurrenceAst.Expression, retTpe: Type, purity: Purity, loc: SourceLocation)
