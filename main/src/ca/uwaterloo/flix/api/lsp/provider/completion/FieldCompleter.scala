...
object FieldCompleter extends Completer {
  ...
  /**
    ...
    */
  override def getCompletions(implicit context: CompletionContext, flix: Flix, index: Index, root: Option[TypedAst.Root], delta: DeltaContext): Iterable[FieldCompletion] = {
