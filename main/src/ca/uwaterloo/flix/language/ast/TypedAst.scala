...
object TypedAst {
  ...
  object Expr {
    ...
    case class StructGet(sym: Symbol.StructSym, exp: Expr, field: Symbol.StructFieldSym, tpe: Type, eff: Type, loc: SourceLocation) extends Expr

    case class StructPut(Sym: Symbol.StructSym, exp1: Expr, field: Symbol.StructFieldSym, exp2: Expr, tpe: Type, eff: Type, loc: SourceLocation) extends Expr
  ...
  case class StructField(name: Symbol.StructFieldSym, tpe: Type, idx: Int, loc: SourceLocation)
