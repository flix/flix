...
object KindedAst {
  ...
  object Expr {
    ...
    case class ApplyClo(exp1: Expr, exp2: Expr, tvar: Type.Var, loc: SourceLocation) extends Expr
    ...
    case class Tag(sym: CaseSymUse, exps: List[Expr], tvar: Type.Var, evar: Type.Var, loc: SourceLocation) extends Expr
