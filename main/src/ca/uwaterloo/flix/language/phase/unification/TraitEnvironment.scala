...
object TraitEnvironment {
  ...
  def entail(tconstrs0: List[Ast.TraitConstraint], tconstr: Ast.TraitConstraint, traitEnv: Map[Symbol.TraitSym, Ast.TraitContext])(implicit flix: Flix): Validation[Unit, UnificationError] = {
  ...
  /**
    ...
    */
  def holds(tconstr: Ast.TraitConstraint, traitEnv: Map[Symbol.TraitSym, Ast.TraitContext])(implicit flix: Flix): Boolean = {
  ...
  /**
    ...
    */
  private def simplify(tconstrs0: List[Ast.TraitConstraint], traitEnv: Map[Symbol.TraitSym, Ast.TraitContext])(implicit flix: Flix): List[Ast.TraitConstraint] = {
  ...
  /**
    ...
    */
  def reduce(tconstrs0: List[Ast.TraitConstraint], traitEnv: Map[Symbol.TraitSym, Ast.TraitContext])(implicit flix: Flix): Validation[List[Ast.TraitConstraint], UnificationError] = {
  ...
  /**
    ...
    */
  private def toHeadNormalForm(tconstr: Ast.TraitConstraint, traitEnv: Map[Symbol.TraitSym, TraitContext])(implicit flix: Flix): Validation[List[Ast.TraitConstraint], UnificationError] = {
  ...
  /**
    ...
    */
  private def byInst(tconstr: Ast.TraitConstraint, traitEnv: Map[Symbol.TraitSym, Ast.TraitContext])(implicit flix: Flix): Validation[List[Ast.TraitConstraint], UnificationError] = tconstr match {
