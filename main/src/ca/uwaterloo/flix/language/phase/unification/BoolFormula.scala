  ...
  implicit val AsBoolAlgTrait: BoolAlg[BoolFormula] = new BoolAlg[BoolFormula] {
    ...
    override def mkAnd(alg1: BoolFormula, alg2: BoolFormula): BoolFormula = (alg1, alg2) match {
      ...
      case _ =>
        ...
        BoolFormula.And(alg1, alg2)
    }

    @tailrec
    override def mkOr(tpe1: BoolFormula, tpe2: BoolFormula): BoolFormula = (tpe1, tpe2) match {
      // T ∨ x => T
      case (BoolFormula.True, _) =>
        BoolFormula.True
      ...
      case _ =>
        ...
        BoolFormula.Or(tpe1, tpe2)
    }

    override def mkNot(f0: BoolFormula): BoolFormula = f0 match {
